...
const Footer = () => {
  ...
  return (
    <section id='Footer' className='bg-orange-400 text-white py-8 sm:py-12 lg:py-16'>
            ...
            <div className='lg:col-span-4'>
              <div className='mb-4'>
                ...
                <p className='text-white/90 text-sm sm:text-base leading-relaxed'>
                  We create innovative digital solutions that transform businesses and deliver 
                  exceptional user experiences through cutting-edge technology and creative design.
                </p>
              </div>
            </div>
