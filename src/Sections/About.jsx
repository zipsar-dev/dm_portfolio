      ...
      <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between mx-auto mt-6 lg:mt-10 gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-[48%]">
          <p className="text-sm leading-relaxed text-gray-700">
            ...
            <br/><br/> 
            Our strength lies in blending creativity with data-driven decision-making. From building
            ...
            focus on strategies that bring real, lasting results.
            <br/><br/> 
            Above all, we believe in transparency, collaboration, and trust. When you work
