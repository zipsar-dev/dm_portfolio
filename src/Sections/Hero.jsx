  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-1">
        <h1 className="text-4xl font-bold">We Craft Bold Digital Stories</h1>
      ...
      <div className="flex gap-4 mt-4">
        <button className="cursor-pointer font-semibold py-2 px-3 bg-orange-400 rounded-[40px]">Let's Create Magic</button>
        <button className="cursor-pointer font-semibold border-2 px-3 py-2 border-orange-400 rounded-[40px]">See Our Work</button>
      </div>
    </section>
  );
};
