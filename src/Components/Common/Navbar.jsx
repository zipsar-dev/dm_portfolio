...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Contact', icon: Phone, to: 'Footer' } // renamed display handled later
  ]
  ...
  const glossyStyle = {
    background: 'linear-gradient(180deg, rgba(203,244,118,0.22), rgba(203,244,118,0.12))',
          ...
          >
            ...
            <div className='flex flex-col space-y-2 px-4 relative z-10'>
              {navItems.map((item, index) => {
                ...
                if (isLast) {
                  // Contact / Footer - scroll to bottom
                  return (
                    <div
                      key={index}
